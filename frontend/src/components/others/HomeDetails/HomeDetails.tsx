        ...
        <React.Fragment>
           <div className='flex flex-col border-b pb-8 border-gray-200'>
                <div className='flex p-4 border-b border-gray-200 justify-between'>
                    ...
                    <img src="https://via.placeholder.com/150" alt="Host avatar"
                ...
                <div className='flex mt-6'>
                    ...
                    <p className='font-bold px-2'> Free cancellation until 2 days before check-in</p>
                </div>
           </div>
           <div className='flex flex-col border-b pb-8 border-gray-200'>
                <div className='flex mt-6'>
                    <p className='px-2'>Every booking includes free protection from Host cancellations, listing inaccuracies, and other issues like trouble checking in.</p>
                </div>
            </div>
            <div className='flex flex-col border-b pb-8 border-gray-200'>
                <div className='flex mt-6'>
