...
namespace AdventureNest.Repository.Migrations
{
    ...
    [Migration("20230409182727_initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdventureNest.Core.Models.PropertyDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AdventureNest.Core.Models.PropertyDetail", b =>
                {
                    b.HasOne("AdventureNest.Core.Models.Property", "Property")
                        ...
                        .HasForeignKey("AdventureNest.Core.Models.PropertyDetail", "PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
